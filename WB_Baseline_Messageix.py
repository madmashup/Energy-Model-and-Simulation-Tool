...
if passenger_IWT:
    ...
    IWT_Share=[0.05,0.08,0.11,0.14,0.17]#Modal Share of IWT
...
if freight_IWT:
    ...
    yrs=[2020,2025,2030,2035,2040]#Years of modal share
    IWTF_Share=[0.05,0.08,0.11,0.14,0.17]#Modal Share of IWT
